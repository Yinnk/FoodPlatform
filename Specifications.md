...
When users to filter restaurants to obtain results that match their preferences. The user has options to filter by dietary restrictions, price or by type of cuisine. It allows users to narrow down the restaurants that they need to look at before making a decision. 
