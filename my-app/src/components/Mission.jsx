  ...
  return (
    <section className="mission py-10 flex flex-col md:flex-row items-center gap-8">
      <div className="mission-text md:w-1/2">
        ...
        <p className='mx-3'>
          At Bite Connect, our mission is to bridge the gap between surplus food and communities in need. Every day, perfectly good meals go to waste while many individuals and families struggle to afford their next one. We’re here to change that.
